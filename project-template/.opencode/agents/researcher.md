---
description: Performs current research, internet search, documentation lookup, and knowledge synthesis using project-local MCPs.
mode: all
permission:
  edit: allow
  bash:
...
Gather and synthesize external information. Focus on searching and extracting knowledge from the internet and documentation.
